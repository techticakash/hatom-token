...
import maiarLogo from './../../assets/resources/assets-per-section/section4/img3.svg';
import elrondLogo from './../../assets/resources/assets-per-section/section4/img1.svg';
      ...
      <InnerContainer>
        ...
        <CompanyContainer>
          <CompanyBox className="first-company">
            <img src={maiarLogo} className="company-logo" />
            <CompanyName>Maiar</CompanyName>
            <CompanyDescription>
              Maiar is powered by the amazing technology of the Elrond blockchain, and is going to
              radically change the way we interact with money.
            </CompanyDescription>
            <p className="card-btn">Learn More </p>
          </CompanyBox>
          <CompanyBox>
            <img src={elrondLogo} className="company-logo" />
